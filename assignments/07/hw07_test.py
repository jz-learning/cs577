...
def get_versions():
    ...
    try:
        with urlopen('https://raw.githubusercontent.com/CS577-testers-SP22/hw07-tester/master/.version') as f:
            if f.status != 200:
                raise Exception
...
if __name__ == '__main__':
    print(f'Running CS577 SP22 HW07 tester v{__version__}')
    ...
    if current < latest:
        ...
        print('You can download the latest version at https://github.com/CS577-testers-SP22/hw07-tester\n')
    print()
    main()
    print()
