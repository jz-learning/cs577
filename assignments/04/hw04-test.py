...
def test8_timeout_tests():
    ...
    print(
        "Running Timeout Tests. These can take a very long time if your code is not efficient. Set TIMEOUT_TEST=False on line 39 if you don't want to test this."
    )
...
def get_versions():
    ...
    try:
        with urlopen(
            "https://raw.githubusercontent.com/CS577-testers-SP22/hw04-tester/master/.version"
        ) as f:
            if f.status != 200:
                raise Exception
...
if __name__ == "__main__":
    ...
    if current < latest:
        ...
        print(
            "You can download the latest version at https://github.com/CS577-testers-SP22/hw04-tester\n"
        )
    print()
    main()
    print()
